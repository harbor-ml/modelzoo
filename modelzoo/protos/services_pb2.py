...
from protos import model_apis_pb2 as protos_dot_model__apis__pb2
...
_PAYLOAD.fields_by_name['image'].message_type = protos_dot_model__apis__pb2._IMAGE
_PAYLOAD.fields_by_name['text'].message_type = protos_dot_model__apis__pb2._TEXT
_PAYLOAD.fields_by_name['table'].message_type = protos_dot_model__apis__pb2._TABLE
